...
if(isset($_POST['cadastrar']) && !empty($_POST['cadastrar']))	{	
	...
	$query = mysqli_query($conn,"INSERT INTO tbbanner (foto) VALUES ('$foto')")  or die (mysqli_error($conn));
	
	echo '<script> alert("Banner foi cadastrado com sucesso!"); window.location="index.php?pg=banner&listar=listar&id=1&ativo=15&link=24"; </script>';
...
if(isset($_POST['editar']) && !empty($_POST['editar']))	{	
	...
	$query = mysqli_query($conn,"UPDATE tbbanner SET
	
	foto = '{$_POST['nomefoto']}'

	 WHERE id  = '{$id}'") or die("Error: " . mysqli_error($conn));
	
	echo '<script> alert("Banner foi atualizado com sucesso!");  window.location="index.php?pg=banner&listar=listar&id=1&ativo=15&link=24"; </script>';
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Lista de banner</li>
      </ol>
    </section>
...
<section class="content container-fluid">
				...
				<form name="cadastro" id="cadastro" method="post" action="">
					<div class="col-md-6">
						...
						<div class="form-group">
							<label for="foto">Banner Home *(largura mínima: 1920px)</label>
  ...
  <span class="form-control"></span>
	...
	<? } if($_GET['listar'] == "listar") { ?>
		<a href="index.php?pg=banner&listar=mostrar&ativo=16&link=25"><div class="btn btn-success" style="margin: 10px;">CADASTRAR BANNER</div></a>	
    ...
    <tbody>
       <? $query = mysqli_query($conn,"Select * from tbbanner");
        ...
        <tr id="item_<?=$dados['id'];?>">
		  ...
		  <a class="btn btn-info" href="index.php?pg=banner&listar=editar&id=<?=$dados['id'];?>&ativo=16&link=25">

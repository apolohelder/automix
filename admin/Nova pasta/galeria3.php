    ...
    <section class="content">
      <div class="row">
		...
		<? if($_GET['listar'] == "mostrar") { 
	       ...
	       $queryalbum = mysqli_query($conn,"Select tbservicos.id, tbservicos.foto, tbcategoria2.categoria, tbcategoria2.id as id2
from tbservicos
Join tbcategoria2
On tbservicos.categoria = tbcategoria2.id WHERE tbcategoria2.id = ".$id."");
  ...
  $('#drag-and-drop-zone').dmUploader({ //
   ...
   return {
    ...
    onComplete: function(){
	  ...
	  $(location).attr('href', 'index.php?pg=servicos&listar=listar&ativo=2&link=7');
    },
...
<div class="container">
   ...
   <?php
   $id = intval($_GET['id']);
   $query = "SELECT * FROM tbgaleriafotos2 WHERE idgaleria = ".$id."";
   ...
   ?>
     <tr id="item_<?=$row["id"];?>">
      <td><div class="img-thumbnail"><img src="uploadfotos2/thumbs/<?=$row["foto"]; ?>" id='img_<?=$row["id"];?>' width="200" class="img-fluid">
